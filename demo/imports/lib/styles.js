...
const styles = {
    antd: style(['https://cdnjs.cloudflare.com/ajax/libs/antd/2.7.0/antd.min.css']),
    ...
    semantic: style(['https://cdnjs.cloudflare.com/ajax/libs/semantic-ui/2.2.7/semantic.min.css']),
