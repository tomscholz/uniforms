...
describe('GraphQLBridge', () => {
    ...
    describe('#getError', () => {
        ...
        it('works with correct error', () => {
            expect(bridgeI.getError('title', {details: [{name: 'title'}]})).toEqual({
                name: 'title'
            });
    ...
    describe('#getSubfields', () => {
        it('works on top level', () => {
            expect(bridgeI.getSubfields()).toEqual(['id', 'author', 'title', 'votes', 'example', 'category']);
        });

        it('works with nested types', () => {
            expect(bridgeI.getSubfields('author')).toEqual(['id', 'decimal', 'firstName', 'lastName', 'level', 'tags']);
        });
