...
describe('ValidatedForm', () => {
    ...
    describe('when reset', () => {
        it('removes `error`', () => {
            const wrapper = mount(<ValidatedForm model={model} schema={schema} onSubmit={onSubmit} />);
    ...
    describe('when submitted', () => {
        ...
        it('skips `onSubmit` when invalid', async () => {
            const wrapper = mount(<ValidatedForm error={error} model={model} schema={schema} onSubmit={onSubmit} />);
        ...
        it('revalidates with new model only if required', () => {
            ...
            const wrapper = mount(<ValidatedForm model={{}} schema={schema} />);
        ...
        it('revalidates with new model', () => {
            ...
            const wrapper = mount(<ValidatedForm model={{}} schema={schema} validate="onChange" />);
        ...
        it('revalidates with new model only when changed', () => {
            ...
            const wrapper = mount(<ValidatedForm model={model} schema={schema} />);
