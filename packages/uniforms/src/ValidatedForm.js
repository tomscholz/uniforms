...
const __unhandled = event => event && event.reason && event.reason[__unhandledMark] && event.preventDefault();
    ...
    class extends parent {
        ...
        onSubmit(event) {
            ...
            return new Promise(resolve =>
                this.setState({validate: true}, () => resolve(this.onValidate().then(() => super.onSubmit())))
            );
        }
